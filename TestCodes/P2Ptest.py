...
# Streamlit app for Peer 1
def main():
    st.title("P2P Communication Simulation - Peer 1")

    peer_id = st.text_input("Enter your Peer ID:", value="Peer1")
    udp_port = st.number_input("Enter your UDP Port:", value=5005, min_value=1024, max_value=65535)
    ...
    if peer_id:
        ...
        if st.button("Send Message"):
            ...
            recipient_port = 5006 if recipient == "Peer2" else udp_port
            sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
